...
<div class="container mt-4">
    <div class="mt-4 mb-4">
        ...
        @else
        <a href="{{ route('{pref_id?}.index', ['pref_id'=>$pref_id,'city_id'=>$city_id,'searchword'=> $searchword,])}}" class="btn btn-primary">
        @endif
            一覧に戻る
        </a>
        ...
        <div class="card-footer py-1 d-flex justify-content-end bg-white mt-1 mb-1">
            ...
            <div class="d-flex align-items-center">
                ...
                @if (!in_array($post->id, array_column($nices->toArray(), 'post_id'), TRUE))
                    <a class="far fa-heart fa-fw fa-lg" style="text-decoration: none;" href="{{ url('pref/'.$pref_id.'/nice/'.$post->id) }}"></a>
                @else
                    <a class="fas fa-heart fa-fw fa-lg" style="text-decoration: none;" href="{{ url('pref/'.$pref_id.'/unnice/'.$post->id) }}"></a>
                @endif
