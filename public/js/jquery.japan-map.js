...
/***/ (function (module, exports) {
      ...
      (function ($) {
        ...
        $.fn.japanMap = function (options) {
          ...
          options = $.extend({
            type: "canvas",
            // Only type of "canvas" exist now. Perhaps "svg" in future.
            selection: "prefecture",
            // "prefecture" or "area"
            width: null,
            // Canvas will be scaled to larger one of "width" and "height".
            height: null,
            color: "#a0a0a0",
            // Default color, which used if no color is set in "areas" object.
            hoverColor: null,
            // If null, "color" will be 20% brightened when hovered.
            backgroundColor: "transparent",
            // Background color of the element, like "canvas".
            borderLineColor: "#ffffff",
            // Border Line of Prefectures.
            borderLineWidth: 0.25,
            lineColor: "#a0a0a0",
            // Border Line of the element and the partition line when "movesIsland" is true.
            lineWidth: 1,
            //drawsBoxLine: true,
            drawsBoxLine: false,
            ...
            movesIslands: false,
            //  Moves Nansei Islands (Okinawa and part of Kagishima) to the left-top space.
            font: "Arial",
            fontSize: null,
            fontColor: null,
        ...
        Map.prototype.findPrefectureByCode = function (code) {
          var results = this.options.prefectures.filter(function (p) {
            return p.code == code;
          });
        ...
        Map.prototype.findAreaBelongingToByCode = function (code) {
          var results = this.options.areas.filter(function (a) {
            return a.prefectures.indexOf(code) > -1;
          });
          return results.length > 0 ? results[0] : null;
        };
        ...
        Map.prototype.getName = function (prefecture_or_area) {
          switch (this.isArea(prefecture_or_area) ? this.options.areaNameType : this.options.prefectureNameType) {
            case "short":
              return this.getShortName(prefecture_or_area);

            case "english":
              return this.getEnglishName(prefecture_or_area);

            case "romaji":
              return this.getEnglishName(prefecture_or_area);

            case "full":
              return prefecture_or_area.name;
        ...
        var MapCanvas = function MapCanvas() {
        ...
        MapCanvas.prototype.render = function () {
          ...
          render.apply(this);
          if (!this.hovering) this.initializeData();
        ...
        MapCanvas.prototype.renderPrefectureMap = function () {
          ...
          this.options.prefectures.forEach(function (prefecture) {
            ...
            context.fill();
            if (this.options.borderLineColor && this.options.borderLineWidth > 0) context.stroke();
          }, this);
        };
        ...
        MapCanvas.prototype.drawName = function () {
          if (!this.options.showsPrefectureName && !this.options.showsAreaName) return;
        ...
        MapCanvas.prototype.drawText = function (prefecture_or_area, point) {
          ...
          if (this.options.fontColor && this.options.fontColor == "areaColor") {
            ...
            var hvColor = area.color && area.hoverColor ? area.hoverColor : area.color ? this.brighten(area.color, 0.2) : this.options.hoverColor ? this.options.hoverColor : this.brighten(this.options.color, 0.2);
        ...
        MapCanvas.prototype.drawIslandsLine = function () {
          ...
          if (this.options.movesIslands) {
            ...
            context.lineTo(200 * this.element.width / this.base.width, 200 * this.element.height / this.base.height);
        ...
        MapCanvas.prototype.setProperties = function (prefecture, area) {
          ...
          if (this.options.borderLineColor) context.strokeStyle = this.options.borderLineColor;
          if (this.options.borderLineWidth) context.lineWidth = this.options.borderLineWidth;
          ...
          if (pointerIsOn) {
            ...
            if (area.hoverColor) context.fillStyle = area.hoverColor; else if (this.options.hoverColor) context.fillStyle = this.options.hoverColor; else context.fillStyle = this.brighten(context.fillStyle, 0.2);
          }
...
/***/ 2:
/*!************************************************!*\
  !*** multi ./resources/js/jquery.japan-map.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function (module, exports, __webpack_require__) {

      module.exports = __webpack_require__(/*! /workspace/resources/js/jquery.japan-map.js */"./resources/js/jquery.japan-map.js");
